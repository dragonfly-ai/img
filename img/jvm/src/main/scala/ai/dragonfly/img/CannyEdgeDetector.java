...
public class CannyEdgeDetector {
    ...
    public static void main(String[] args) {
        try {
            ...
            ced.setEdgesImage(new BufferedImage(bi.getWidth(), bi.getHeight(), BufferedImage.TYPE_INT_ARGB));
            ced.process();

            ImageIO.write(ced.edgesImage, "png", new File("/home/c/img/" + System.currentTimeMillis() + ".png"));
        } catch (Exception e) {
